...
void mml::type_checker::do_call_node(mml::function_call_node *const node, int lvl) {
  // EMPTY
}

void mml::type_checker::do_function_self_node(mml::function_self_node *const node, int lvl) {
  // EMPTY
}
